...
export const metadata = { title: "Edit Brightstone Piece" };

export default async function EditBrightstoneProduct({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <ProductEditor product={product} companyId={company.id} categories={categories} storageDir="brightstone" priceOnRequest />
    </div>
  );
}
